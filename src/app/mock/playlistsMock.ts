...
export class PlaylistsMock {
    ...
    constructor() {
        ...
        this.playlists[0].musicas[0] = {id: 0, nome: "24kGoldn - Mood (feat. iann dior)", album: "", artista: "24kGoldn", duration: 132600, audio: "assets/musics/Playlists/As 50 mais tocadas no mundo/24kGoldn - Mood (feat. iann dior).mp3"}
